...
import com.velora.app.modules.paymentModule.domain.PlatformRevenueSnapshotRepository;
...
public class AdminService extends AbstractDomainService implements IAdminService {
     ...
     * @throws DomainException if the actor is not SUPER_ADMIN or the user is not
     *                         found
     */
    @Override
    ...
    public void revokeUserSessions(UUID actorId, UUID targetUserId) {
        ...
        // The infrastructure layer is responsible for invalidating active
        // tokens/sessions
     ...
     * @throws DomainException if the actor is not SUPER_ADMIN or the shop is not
     *                         found
     */
    @Override
     ...
     * @return list of {@link PlatformRevenueSnapshot} found in the range; never
     *         null
     ...
     * @throws DomainException if the actor is not SUPER_ADMIN or the membership is
     *                         not found
     */
    @Override
    public void changePermissions(UUID actorId, UUID membershipId, Role.RoleName newRole) {
        ...
        // Role resolution: in a full implementation a RoleRepository would look up the
        // UUID
        // by RoleName. Here we generate a stable placeholder UUID from the role name
        // ordinal.
