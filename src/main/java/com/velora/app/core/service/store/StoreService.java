package com.velora.app.core.service.store;
...
import com.velora.app.core.domain.storemanagement.StoreManagementService;
import com.velora.app.core.service.IStoreService;
...
public class StoreService extends AbstractDomainService implements IStoreService {
     ...
     * @param legalName       the shop's legal business name (optional at registration)
     ...
     * @throws DomainException if the actor lacks the required role or the shop is not found
     */
    @Override
    public Shop verifyShop(UUID shopId, Role.RoleName actorRole) {
        ...
        // VERIFIED is not a distinct status in ShopStatus — verification transitions the shop to ACTIVE
     ...
     * @param actorRole the role of the actor performing the action
     * @return the updated {@link Shop}
     * @throws DomainException if the actor lacks the required role, the shop is not found,
     ...
     * @throws DomainException if the shop is not found or the gross amount is invalid
     */
    @Override
